...
CREATE TABLE `ima` (
  ...
  CONSTRAINT `FK_SifKor_Ima` FOREIGN KEY (`SifKor`) REFERENCES `igrac` (`SifKor`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `ima` VALUES (4,1),(1,2);
