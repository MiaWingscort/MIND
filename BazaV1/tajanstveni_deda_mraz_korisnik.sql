...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Generalizacija svih korisnika naseg sistema; specijalizuje se na Igraca, Administratora i Prodavca';
...
INSERT INTO `korisnik` VALUES (1,'danijelamijailovic5@gmail.com','daca123','N'),(2,'igluma95@gmail.com','igor123','N'),(3,'granicmina95@gmail.com','mina123','N'),(4,'nikolajevremovic95@gmail.com','jele123','N');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tajanstveni_deda_mraz`.`korisnik_BEFORE_INSERT` BEFORE INSERT ON `korisnik` FOR EACH ROW
BEGIN
